...
class FitLogPalettes {
  ...
  static const blue = FitLogColors(
    ...
    input: Color(0xFFFFFFFF),
    outline: Color(0xFFD4E7F3),
    outlineSubtle: Color(0xFFE5F0F8),
    primary: Color(0xFF55DCE2),
    primaryBright: Color(0xFF55DCE2),
    primaryDeep: Color(0xFF1E4D72),
    primaryStrong: Color(0xFF315FEA),
    primaryText: Color(0xFF162B3A),
    primarySoft: Color(0xFFE5FAFA),
    primarySoftPressed: Color(0xFFD7F4F5),
    primarySoftSelected: Color(0xFFE5FAFA),
    onPrimary: Color(0xFF162B3A),
    textPrimary: Color(0xFF10232D),
    textSecondary: Color(0xFF526E7D),
    textMuted: Color(0xFF708693),
    textDisabled: Color(0xFFA5B4BD),
    pageGradientTop: Color(0xFFFFFFFF),
    pageGradientMiddle: Color(0xFFFFFFFF),
